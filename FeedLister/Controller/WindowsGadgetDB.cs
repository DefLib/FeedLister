...
namespace FeedLister.Controller
{
    ...
    public class WindowsGadgetDB
    {
        public void CreateTable()
        {
            ...
            string sql = "CREATE TABLE 'channel' ('id' INTEGER NOT NULL,'title' TEXT NOT NULL UNIQUE,'link' TEXT NOT NULL UNIQUE,'feedLink' TEXT NOT NULL UNIQUE,'description' TEXT NOT NULL,PRIMARY KEY('id' AUTOINCREMENT))";
